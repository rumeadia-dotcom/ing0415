...
> 출처: <https://developers.coupangcorp.com/hc/ko/articles/360034209513>
> Zendesk article id: `360034209513`
> 섹션: 쿠폰 / 캐시백 APIs
> 추출 시점: 2026-05-28
...
| page | | | | |  | Number | 페이지. 기본값 1  다음 페이지를 호출하기 위한 키값. 첫 페이지 호출시에는 넣지 않거나 '1' 입력 |
...
|  | content | | | | Array | 쿠폰 리스트 |
|  |  | contractId | | | Number | 계약서ID |
|  |  | vendorContractId | | | Number | 업체의 계약서 코드(쿠팡 관리 코드)  예) -1, 1, 2 |
|  |  | couponId | | | Number | 쿠폰ID |
|  |  | discount | | | Number | 할인율 |
