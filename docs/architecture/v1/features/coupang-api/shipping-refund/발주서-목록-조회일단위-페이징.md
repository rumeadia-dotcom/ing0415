...
> 출처: <https://developers.coupangcorp.com/hc/ko/articles/360033919573>
> Zendesk article id: `360033919573`
> 섹션: 배송 / 환불 APIs
> 추출 시점: 2026-05-28
...
※ 발주서 목록 조회는 주문 건이 많을 경우, 타임아웃이 발생할 수 있습니다. [[타임아웃 대처방법]](https://developers.coupangcorp.com/hc/ko/articles/360022937714) 페이지 링크를 확인하신 후, 타임아웃 시간을 늘려주시기 바랍니다.
...
| Name | | | | Required | Type | Description |
| --- | --- | --- | --- | --- | --- | --- |
| createdAtFrom | | | | O | String | 검색 시작일시（[ISO-8601](https://en.wikipedia.org/wiki/ISO_8601)표준을 준수해야 합니다.）  "yyyy-mm-dd%2B09:00" 형태로 조회하기 원하는 시작 날짜 기입 ex) 2025-07-01%2B09:00 |
| createdAtTo | | | | O | String | 검색 종료일시（[ISO-8601](https://en.wikipedia.org/wiki/ISO_8601)표준을 준수해야 합니다.）  "yyyy-mm-dd%2B09:00" 형태로 조회하기 원하는 종료 날짜 기입 ex) 2025-07-31%2B09:00  최대 31일까지 조회 가능합니다. |
...
|  |  | name | | String | 수취인 이름 |
|  |  | safeNumber | | String | 수취인 연락처(안심번호)（[E.164](https://en.wikipedia.org/wiki/E.164)표준을 준수해야 합니다.） |
|  |  | receiverNumber | | String | 수취인 연락처(실전화번호)（[E.164](https://en.wikipedia.org/wiki/E.164)표준을 준수해야 합니다.） |
...
|  |  | invoiceNumberUploadDate | | String | 운송장번호 업로드 일시（[ISO-8601](https://en.wikipedia.org/wiki/ISO_8601)표준을 준수해야 합니다.）  optional / yyyy-MM-dd'T'HH:mm:ss |
...
|  |  | confirmDate | | String | 구매확정일자（[ISO-8601](https://en.wikipedia.org/wiki/ISO_8601)표준을 준수해야 합니다.）  yyyy-MM-dd HH:mm:ss |
