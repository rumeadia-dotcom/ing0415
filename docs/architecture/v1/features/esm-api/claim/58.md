...
| --- |
| **Description** |
| [POST] https://sa2.esmplus.com/claim/v1/sa/return/{orderno}/exchange |
| 반품주문 건을 교환으로 전환합니다. 반품 사유가 판매자 귀책이면 교환 전환시 판매자 귀책으로 전환되고, 반품 사유가 구매자 귀책이면 교환 전환시 구매자 귀책으로 전환됩니다.  (결제수단은 “판매자 직접결제”로 내려감)  G마켓 주문 경우 “교환신청”상태로 전환되며, 옥션 주문 경우 “교환재발송 송장등록” 상태(재발송완료는 아님)로 전환됩니다. 옥션 주문일 경우 재발송택배사 및 송장번호를 필수로 입력해야 합니다. |
...
{
   "ResultCode":8668,
   "Message":"교환신청을 1회 했을 경우 신청 할 수 없습니다.",
   "Data":null
}
...
{
    "ResultCode": 8668,
    "Message": "빠른환불 대상건은 교환 변경 불가 합니다",
    "BizRuleCode": "W13-2",
    "Data": null
}
```
