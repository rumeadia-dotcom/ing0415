...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=43&apiSeq=6760&apiSpecType=1
> categoryNo: `43` · apiSeq: `6760` · 섹션: 상품 > 배송
...
|---|---|
| Method | `POST` |
| URL | `http://api.11st.co.kr/rest/areaservice/visit/registerVisitAddress` |
| Protocol | http |
| Version | 1.0 |
| 요청 형식 | xml |
| 응답 형식 | xml |
