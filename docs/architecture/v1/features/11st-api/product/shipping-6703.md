...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=43&apiSeq=6703&apiSpecType=1
> categoryNo: `43` · apiSeq: `6703` · 섹션: 상품 > 배송
...
|---|---|
| Method | `POST` |
| URL | `http://api.11st.co.kr/rest/areaservice/v2/updateOutAddress` |
| Protocol | http |
| Version | 1.0 |
| 요청 형식 | xml |
| 응답 형식 | xml |
...
| &nbsp;&nbsp;`ns2:result_message` | 결과내용 | string | Y |  | 출고지 수정 오류 : OpenAPI Key 에 해당하는 유저가 없습니다. |  |
