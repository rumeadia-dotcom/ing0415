...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=43&apiSeq=6701&apiSpecType=1
> categoryNo: `43` · apiSeq: `6701` · 섹션: 상품 > 배송
...
|---|---|
| Method | `POST` |
| URL | `http://api.11st.co.kr/rest/areaservice/v2/registerOutAddress` |
| Protocol | http |
| Version | 1.0 |
| 요청 형식 | xml |
| 응답 형식 | xml |
...
| &nbsp;&nbsp;`prtblTlphnNo` | 휴대전화번호 | string | Y |  | 010-1111-1111 | 입력형식 예시) 010-1111-2222 |
...
| &nbsp;&nbsp;`addrClfCd` | 주소 구분 | string |  |  | 01 | 기본값은 도로명. 도로명인 경우 01, 지번인 경우 02 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`addrNm` | 주소명 | string | Y |  | 본사 |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`addrSeq` | 주소 순번 | string | Y |  | 14 | 상품등록시 주소 순번으로 출고지, 반품/교환지를 정하실 수 있습니다. |
| &nbsp;&nbsp;&nbsp;&nbsp;`rcvrNm` | 이름 | string | Y |  | 홍길동 |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`gnrlTlphnNo` | 일반전화번호 | string | Y |  | 02-0000-0000 |  |
...
|---|---|---|---|---|---|---|
| `ns2:inOutAddresss` | ns2:inOutAddresss | object | Y |  |  |  |
| &nbsp;&nbsp;`ns2:result_message` | 결과내용 | string | Y |  | 출고지 등록 오류 : OpenAPI Key 에 해당하는 유저가 없습니다. |  |
