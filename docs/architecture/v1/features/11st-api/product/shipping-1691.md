...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=43&apiSeq=1691&apiSpecType=1
> categoryNo: `43` · apiSeq: `1691` · 섹션: 상품 > 배송
...
|---|---|---|---|---|---|---|
| `ns2:inOutAddresss` | ns2:inOutAddresss | object | Y |  |  |  |
| &nbsp;&nbsp;`ns2:result_message` | 결과내용 | string | Y |  | 출고지 조회 오류 : OpenAPI Key 에 해당하는 유저가 없습니다. |  |
