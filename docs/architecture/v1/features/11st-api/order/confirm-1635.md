# Seller - 주문 - 발송처리할 내역 (배송준비중 목록조회)

> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=111&apiSeq=1635&apiSpecType=1
> categoryNo: `111` · apiSeq: `1635` · 섹션: 주문 > 발주처리
...
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/ordservices/packaging/[startTime]/[endTime]` |
| Protocol | https |
| Version | 1.2 |
| 응답 형식 | xml |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`stlPlnAmt` | 정산예정금액 | string | Y |  | 19000 |  |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`dlvSndDue` | 발송마감일자 | string | Y |  |  | 발송마감일자<br><br>2019/05/30 부터 신규제공 (주문시 발송약속한 마감일자) |
| &nbsp;&nbsp;&nbsp;&nbsp;`delaySendDt` | 발송예정일자 | string | Y |  |  | 발송예정일자<br><br>2019/05/30 부터 신규제공 (발송지연안내 한 일자) |
| &nbsp;&nbsp;&nbsp;&nbsp;`sendGiftYn` | 선물하기여부 | string |  |  | Y | 2021/03/04 부터 신규제공 (선물 주문건인지 확인) |
| &nbsp;&nbsp;&nbsp;&nbsp;`sendClfCd` | 오늘발송 설정 상품 여부 | string | Y |  | Y | 2021/08/26 부터 신규제공(Y/N) |
| &nbsp;&nbsp;&nbsp;&nbsp;`tmallDscPrcPerSeq` | 순번별 11번가 할인금액 | integer | Y |  | 0 |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`sellerDscPrcPerSeq` | 순번별 판매자 할인금액 | integer | Y |  | 0 |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`ordPayAmtPerSeq` | 순번별 결제금액 | integer | Y |  | 0 |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`visitDlvYn` | 방문수령여부 | string |  |  | N |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`psnCscUniqNo` | 개인통관고유부호 | string |  |  |  |  |
