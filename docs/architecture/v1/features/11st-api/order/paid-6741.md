...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=110&apiSeq=6741&apiSpecType=1
> categoryNo: `110` · apiSeq: `6741` · 섹션: 주문 > 결제완료
...
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/ordservices/todaydelivery/completes` |
| Protocol | https |
| Version | 1.1 |
| 응답 형식 | xml |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`bmDlvCstType` | 도서산간배송비 착불 여부 | enum | Y | 5 | 04 | 2014/12/19(금) 주문건부터 신규제공 (코드값: 01=선불, 02=착불, 03=도서산간배송비 청구 필요 (선물하기 주문)) |
