# Seller - 주문 - 배송지 입력대기 목록조회

> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=110&apiSeq=1800&apiSpecType=1
> categoryNo: `110` · apiSeq: `1800` · 섹션: 주문 > 결제완료
...
선물하기 결제가 완료되어 배송지 입력을 기다리는 상품입니다.

| 항목 | 값 |
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/ordservices/delvplacestandby/[startTime]/[endTime]` |
| Protocol | https |
| Version | 1.2 |
| 응답 형식 | xml |
