...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=67&apiSeq=1732&apiSpecType=1
> categoryNo: `67` · apiSeq: `1732` · 섹션: 전세계배송 > 조회
...
전세계배송주문의 현재 상태 값을 조회합니다.

| 항목 | 값 |
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/claimservice/ordclmstat/[ordNo]/[ordPrdSeq]` |
| Protocol | https |
| Version |  |
| 응답 형식 | xml |
