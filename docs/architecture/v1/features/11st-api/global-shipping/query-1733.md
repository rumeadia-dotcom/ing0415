# 물류 - 전세계배송 - 현재 상태 값 조회(List)

> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=67&apiSeq=1733&apiSpecType=1
> categoryNo: `67` · apiSeq: `1733` · 섹션: 전세계배송 > 조회
...
전세계배송(List)주문의 현재 상태 값을 조회합니다.

| 항목 | 값 |
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/claimservice/ordclmstatlist/[ordNoArr]` |
| Protocol | https |
| Version |  |
| 응답 형식 | xml |
...
|---|---|---|---|---|---|---|
| `ordNoArr` | 주문번호 | string | Y |  | 201205020420003,201205030435008,201205030435015,201205030435022,201205030435025 |  |
