...
> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=67&apiSeq=1747&apiSpecType=1
> categoryNo: `67` · apiSeq: `1747` · 섹션: 전세계배송 > 조회
...
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/ordservices/gbldlvorder/[ordNo]/[ordPrdSeq]` |
| Protocol | https |
| Version |  |
| 응답 형식 | xml |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`ordPrdStat` | 주문상태code | enum | Y |  | 202 | (코드값: 202 =결제완료, 301=발주확인, 401=발송완료, 501=배송완료, 601=클레임진행중, 701=취소처리중) |
...
|---|---|---|---|---|---|---|
| `ns2:orders` | ns2:orders | object | Y |  |  |  |
| &nbsp;&nbsp;`ns2:result_code` | 결과코드 | enum | Y |  |  | (코드값: 0=조회된 결과가 없습니다., -1=전세계배송 주문/클레임 조회 <br>설명 - 조회된 결과값이 없을 경우입니다. 에러가 아닙니다., -1000=서버 점검중입니다.) |
