# 물류 - 전세계배송 - 주문내역조회 내역(List)

> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=67&apiSeq=1746&apiSpecType=1
> categoryNo: `67` · apiSeq: `1746` · 섹션: 전세계배송 > 조회
...
|---|---|
| Method | `GET` |
| URL | `https://api.11st.co.kr/rest/ordservices/gbldlvlist/[startTime]/[endTime]` |
| Protocol | https |
| Version |  |
| 응답 형식 | xml |
