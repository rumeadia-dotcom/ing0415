# Seller - 긴급알리미 - 긴급알리미 조회

> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=58&apiSeq=1796&apiSpecType=1
> categoryNo: `58` · apiSeq: `1796` · 섹션: 알리미 > 알림조회관리
...
| &nbsp;&nbsp;&nbsp;&nbsp;`emerTypeCd` | 알리미 유형 | enum | Y | 2 | 01 | 구버전, emerNtceClfNo1 으로 대체 (코드값: 01=답변요청, 02=공지) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`emerNtceClfNo1` | 게시물분류번호 1단계 | enum | Y |  | 10 | (코드값: 10=긴급문의, 11=긴급알림) |
| &nbsp;&nbsp;&nbsp;&nbsp;`emerNtceClfNm1` | 게시물분류명 1단계 | string | Y | 100 | 긴급알림 |  |
