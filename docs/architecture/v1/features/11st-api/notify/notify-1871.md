# Seller - 긴급알리미 - 긴급알리미조회_구분코드_주문번호별

> 출처: https://openapi.11st.co.kr/openapi/OpenApiGuide.tmall?categoryNo=58&apiSeq=1871&apiSpecType=1
> categoryNo: `58` · apiSeq: `1871` · 섹션: 알리미 > 알림조회관리
