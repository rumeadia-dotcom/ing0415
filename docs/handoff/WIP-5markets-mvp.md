# MarketCast — WIP 핸드오프 (v0.17 운영 배포 완료 · 11번가 plumbing + deno check + RLS fix)

**develop HEAD**: `325de66` — chore(tooling): supabase 스크립트 npx 포터블화 (#297)
**main HEAD**: `bf89065` — release: v0.17 (#299) · **Deploy (real) success (2026-05-31)** — Pages + Edge Functions + Sentry
**테스트**: 1370 passed / 1 skipped / 31 todo (122 files) · **deno check 25 entrypoint green**
**갱신일**: 2026-05-31 (v0.17 운영 배포 완료 — RLS seller_id default fix + npx 포터블화)
