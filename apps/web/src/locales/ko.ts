...
export const ko = {
  ...
  orders: {
    ...
    dashboard: {
      title: '주문 현황',
      subtitle: '오늘 신규 주문과 배송 처리 상태를 한눈에 확인하세요',
      summary: {
        newOrders: '신규 주문',
        logenRegistered: '로젠 등록 완료',
        printPending: '출력 대기',
        dispatched: '제출 완료',
      },
      cta: {
      ...
      empty: {
        title: '오늘 새로 들어온 주문이 없어요',
        body: '신규 주문은 10분마다 자동으로 수집됩니다.',
      },
      banner: {
        logenNotConnected: '로젠 API 가 연결되어 있지 않습니다. 배송 자동 처리를 사용하려면 연결을 완료해주세요.',
        logenConnect: '배송 설정으로 이동',
      },
    },
    list: {
      title: '주문 목록',
      subtitle: '필터로 마켓·기간·상태를 좁혀서 조회할 수 있어요',
      filter: {
        market: '마켓',
        status: '상태',
        dateFrom: '시작일',
    ...
    detail: {
      ...
      sections: {
        ...
        timeline: '배송 상태 타임라인',
        logen: '로젠 등록',
        marketDispatch: '마켓 송장 제출',
      },
      timeline: {
        collected: '수집됨',
        logenRegistered: '로젠 등록',
        waybillPrinted: '운송장 출력',
        trackingSubmitted: '송장 제출 완료',
      },
      logen: {
        notRegistered: '아직 로젠에 등록되지 않았습니다.',
        slipNo: '운송장번호',
        fixTakeNo: '로젠 주문 ID',
        failed: '로젠 등록에 실패했습니다.',
        manualResolveCta: '수동으로 처리',
      },
    },
    status: {
      collected: '수집됨',
      logen_registered: '로젠 등록 완료',
      logen_failed: '로젠 등록 실패',
      waybill_printed: '운송장 출력 완료',
      tracking_submitted: '송장 제출 완료',
      dispatch_failed: '송장 제출 실패',
    },
    manualResolve: {
      title: '운송장번호 직접 입력',
      body: '로젠 자동 등록에 실패한 주문입니다. 수동으로 운송장번호를 입력하면 후속 송장 제출이 진행됩니다.',
      label: '운송장번호',
      placeholder: '예: 123456780001',
      hint: '로젠택배 운송장번호 12자리를 입력해주세요.',
      submit: '저장하고 계속',
      submitting: '저장 중…',
      cancel: '취소',
      success: '운송장번호가 저장되었습니다.',
      error: '저장에 실패했어요. 입력값을 확인하고 다시 시도해주세요.',
    },
  },
  shipping: {
    placeholder: 'v2 작업 진행 중입니다. 본 화면은 곧 활성화됩니다.',
