  ...
  settings: {
    ...
    shipping: {
      ...
      esmProfilesCard: {
        title: 'G마켓·옥션 배송 프로필',
        description:
          'G마켓·옥션(ESM) 상품 등록에 쓰일 출하지·발송정책을 미리 만들어 두면, 상품 등록 화면에서 선택만 하면 됩니다.',
        manageButton: '배송 프로필 관리',
        count: '등록된 프로필 {count}개',
      },
      esmProfiles: {
        title: 'G마켓·옥션 배송 프로필',
        subtitle:
          'ESM 상품 등록에 필요한 출하지·묶음배송·발송정책을 한 번 만들어 재사용합니다. 생성 시 G마켓/옥션에 주소록·출하지·발송정책이 등록됩니다.',
        backLink: '배송 설정으로',
        listTitle: '등록된 배송 프로필',
        listDescription:
          '마켓 계정별 배송 프로필 목록입니다. 상품 등록 3단계에서 이 프로필을 선택합니다.',
        addCta: '새 배송 프로필',
        siteLabel: { G: 'G마켓', A: '옥션' },
        statusLabel: { active: '정상', error: '오류' },
        feeFree: '무료배송',
        feeUnit: '원',
        dispatchTypeLabels: {
          A: '당일발송',
        ...
        columns: {
          ...
          dispatchType: '발송유형',
          fee: '배송비',
          dispatchPolicyNo: '발송정책번호',
          status: '상태',
        },
        empty: {
          title: '등록된 배송 프로필이 없습니다',
          body: 'G마켓·옥션 상품을 등록하려면 배송 프로필을 1개 이상 만들어 주세요.',
        },
        noEsmAccount: {
          title: 'G마켓·옥션 계정이 연결되어 있지 않습니다',
          body: '배송 프로필을 만들려면 먼저 G마켓 또는 옥션 계정을 연결하세요.',
          cta: '마켓 계정 연결',
        },
        dialog: {
          title: '새 배송 프로필',
          description:
            'G마켓·옥션에 등록할 출하지와 발송정책 정보를 입력하세요. 입력한 주소·연락처는 ESM 에만 전달되며 저장되지 않습니다.',
          accountLabel: '마켓 계정',
          accountPlaceholder: '계정을 선택하세요',
          profileLabelLabel: '프로필명',
          profileLabelPlaceholder: '예: 기본 출고지 / 택배',
          dispatchTypeLabel: '발송유형',
          shippingFeeLabel: '기본 배송비 (원)',
          shippingFeePlaceholder: '예: 3000 (0 이면 무료배송)',
          feeTypeLabel: '배송비 유형',
          addressSectionLabel: '출하지 주소 (ESM 에만 전달, 저장 안 함)',
          zipCodeLabel: '우편번호',
          addressMainLabel: '기본 주소',
          addressDetailLabel: '상세 주소 (선택)',
        ...
        blocking: {
          noAccount: 'G마켓 또는 옥션 계정 연결이 필요합니다',
          noLabel: '프로필명을 입력하세요',
          noAddress: '출하지 주소·담당자·연락처를 입력하세요',
        },
        toast: {
          createSuccess: '배송 프로필을 생성했습니다.',
          createError: '배송 프로필 생성에 실패했습니다.',
        },
        errors: {
          profile_label_duplicate: '동일한 이름의 배송 프로필이 이미 있습니다.',
          not_esm_market: 'G마켓·옥션 계정이 아닙니다.',
          site_mismatch: '선택한 계정과 마켓이 일치하지 않습니다.',
          unauthenticated: '로그인이 만료되었습니다. 다시 로그인 후 시도해주세요.',
          fetch: '배송 프로필을 불러오지 못했습니다. 잠시 후 다시 시도해주세요.',
          internal: '예상치 못한 오류가 발생했습니다. 잠시 후 다시 시도해주세요.',
        },
      },
    },
