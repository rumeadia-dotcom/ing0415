 ...
 *   - coupang (hmac)    : 활성. useMock=true → mock, useMock=false → real.
 *   - gmarket (esm_jwt) : 활성. useMock=true → mock, useMock=false → real.
 *   - auction (esm_jwt) : 활성. useMock=true → mock, useMock=false → real.
