 ...
 *
 * - 좌우 가운데 정렬 + 상단 브랜드 + 카드 컨테이너 (페이지가 카드 내부 채움)
    ...
    <div className="flex min-h-screen flex-col bg-surface-subtle">
      <header className="flex items-center justify-center px-4 pt-10 pb-6">
        <div className="flex items-center gap-2">
          <div
            aria-hidden="true"
            className="flex h-9 w-9 items-center justify-center rounded-md bg-accent font-bold text-white"
          >
            M
          </div>
          <span className="text-h2 text-text">MarketCast</span>
        </div>
      </header>
