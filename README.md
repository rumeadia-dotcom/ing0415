...
**v1 정식 = 네이버 스마트스토어. v2 예정 = 쿠팡 / 11번가 / G마켓 / 옥션.**

- 쿠팡은 OpenAPI 가 HMAC 기반이라 v2 어댑터 인터페이스 확장(OAuth code | HMAC key union) 후 통합 예정 (2026-05-19 결정, OQ-10).
- 11번가 / G마켓 / 옥션은 Phase 2 진입 시 사양 확정 후 통합.
